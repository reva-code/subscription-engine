...
Jio Subscription Engine — TMF Open API microservices (group project)

## Teams

| Team | Domain |
|------|--------|
| Atlas | Customer & Order |
| Nova | Usage & Fulfillment |
| Apex | Payments & Comms |

## Modules

| Service | TMF API | Team |
|---------|---------|------|
| customer-management-service | TMF629 | Atlas |
| party-role-service | TMF669 | Atlas |
| product-catalog-service | TMF620 | Atlas |
| product-order-service | TMF622 | Atlas |
| usage-management-service | TMF635 | Nova |
| product-usage-service | TMF677 | Nova |
| product-inventory-service | TMF637 | Nova |
| process-flow-service | TMF701 | Nova |
| payment-management-service | TMF676 | Apex |
| payment-method-service | TMF670 | Apex |
| communication-service | TMF681 | Apex |
| payment-gateway-adapter | N/A | Apex |
| common-lib | N/A | Apex |

## Tech Stack

Java 17 · Spring Boot 3.3.13 · MariaDB · Spring Data JPA · SpringDoc 2.6 · JUnit 5 · Testcontainers
=======
